...
define i256 @__system_request_fallback(i256 %index_address, i256 %calldata_size, i256* nocapture readonly %calldata_pointer) "noinline-oz" #1 personality i32()* @__personality {
entry:
