...
err:
  ...
  %flag = call i256 @llvm.eravm.iflt(i256 1, i256 0)
  %is_set = trunc i256 %flag to i1
  br i1 %is_set, label %revert, label %err_ok

revert:
  call void @llvm.eravm.throw(i256 %res)
  unreachable
