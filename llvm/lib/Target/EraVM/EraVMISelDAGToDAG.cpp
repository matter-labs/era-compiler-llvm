...
///
namespace {
class EraVMDAGToDAGISel final : public SelectionDAGISel {
public:
  EraVMDAGToDAGISel(EraVMTargetMachine &TM, CodeGenOptLevel OptLevel)
...
class EraVMDAGToDAGISelLegacy : public SelectionDAGISelLegacy {
public:
  static char ID;
  explicit EraVMDAGToDAGISelLegacy(EraVMTargetMachine &TM,
                                   CodeGenOptLevel OptLevel)
      : SelectionDAGISelLegacy(
            ID, std::make_unique<EraVMDAGToDAGISel>(TM, OptLevel)) {}
};
} // end anonymous namespace

char EraVMDAGToDAGISelLegacy::ID;

INITIALIZE_PASS(EraVMDAGToDAGISelLegacy, DEBUG_TYPE, PASS_NAME, false, false)
...
FunctionPass *llvm::createEraVMISelDag(EraVMTargetMachine &TM,
                                       CodeGenOptLevel OptLevel) {
  return new EraVMDAGToDAGISelLegacy(TM, OptLevel);
}
