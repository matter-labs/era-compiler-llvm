//===-- EraVMMCInstLower.cpp - Lower MachineInstr to MCInst -----*- C++ -*-===//
//
...
bool EraVMMCInstLower::lowerOperand(const MachineOperand &MO,
  ...
  case MachineOperand::MO_CImmediate:
    if (MO.getCImm()->getValue().getSignificantBits() <= 64) {
