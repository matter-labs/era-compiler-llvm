...
//===----------------------------------------------------------------------===//
//
// This pass performs optimizations after CodeGenPrepare pass. Currently, it is
// only performing transformation from signed to unsigned compares where it is
// feasible.
//
//===----------------------------------------------------------------------===//
...
// Since we don't have signed compare instructions, try to transform them into
// unsigned compares where possible. Currently, it is trying to do following
// transformations:
