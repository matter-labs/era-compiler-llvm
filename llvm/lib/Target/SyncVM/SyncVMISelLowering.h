...
namespace llvm {
  ...
  public:
    ...
    SDValue LowerOperation(SDValue Op, SelectionDAG &DAG) const override { return SDValue {}; }

    /// getTargetNodeName - This method returns the name of a target specific
    /// DAG node.
    const char *getTargetNodeName(unsigned Opcode) const override { return nullptr; }
  ...
  private:
    ...
    LowerFormalArguments(SDValue Chain, CallingConv::ID CallConv, bool isVarArg,
                         ...
                         SmallVectorImpl<SDValue> &InVals) const override { return SDValue {}; }
    SDValue
    ...
    SDValue LowerReturn(SDValue Chain, CallingConv::ID CallConv, bool isVarArg,
                        ...
                        const SDLoc &dl, SelectionDAG &DAG) const override { return SDValue {}; };
