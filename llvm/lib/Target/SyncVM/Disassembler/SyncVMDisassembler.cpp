...
static const unsigned GR8DecoderTable[] = {
    SyncVM::PCB,  SyncVM::SPB,  SyncVM::SRB,  SyncVM::CGB,
    SyncVM::R4B,  SyncVM::R5B,  SyncVM::R6B,  SyncVM::R7B,
    SyncVM::R8B,  SyncVM::R9B,  SyncVM::R10B, SyncVM::R11B,
    SyncVM::R12B, SyncVM::R13B, SyncVM::R14B, SyncVM::R15B
};
...
static const unsigned GR16DecoderTable[] = {
    SyncVM::PC,  SyncVM::SP,  SyncVM::SR,  SyncVM::CG,
    SyncVM::R4,  SyncVM::R5,  SyncVM::R6,  SyncVM::R7,
...
#include "SyncVMGenDisassemblerTables.inc"
...
DecodeStatus SyncVMDisassembler::getInstructionI(MCInst &MI, uint64_t &Size,
...
DecodeStatus SyncVMDisassembler::getInstructionII(MCInst &MI, uint64_t &Size,
                                                  ArrayRef<uint8_t> Bytes,
                                                  uint64_t Address,
                                                  raw_ostream &CStream) const {
  uint64_t Insn = support::endian::read16le(Bytes.data());
...
static SyncVMCC::CondCodes getCondCode(unsigned Cond) {
  switch (Cond) {
  case 0: return SyncVMCC::COND_NE;
  case 1: return SyncVMCC::COND_E;
  case 2: return SyncVMCC::COND_LO;
  case 3: return SyncVMCC::COND_HS;
  case 4: return SyncVMCC::COND_N;
  case 5: return SyncVMCC::COND_GE;
  case 6: return SyncVMCC::COND_L;
  case 7: return SyncVMCC::COND_NONE;
  default:
    llvm_unreachable("Cond out of range");
  }
}

DecodeStatus SyncVMDisassembler::getInstructionCJ(MCInst &MI, uint64_t &Size,
                                                  ArrayRef<uint8_t> Bytes,
                                                  uint64_t Address,
                                                  raw_ostream &CStream) const {
  uint64_t Insn = support::endian::read16le(Bytes.data());
  ...
  if (Cond == 7)
    MI.setOpcode(SyncVM::JMP);
  else {
    MI.setOpcode(SyncVM::JCC);
