...
; CHECK: llvm.syncvm.nearcall parameter #1 must be a statically known pointer to a function (bitcasted to i256* if non-opaque pointers are used)
...
define i256 @ok3() {
  %1 = call i256(ptr, i256, ...) @llvm.syncvm.nearcall(ptr @bar, i256 42, i1 0, i256 0, i256* null, {i256, i256}* null)
  ret i256 %1
}
