...
; CHECK:  add   code[17185], r2, r3               ; encoding: [0x00,0x00,0x43,0x21,0x03,0x20,0x00,0x41]
...
; CHECK:  add   code[@constant+r1], r2, r3             ; encoding: [0x00,0x00,A,A,0x03,0x21,0x00,0x41]
; CHECK:  ;   fixup A - offset: 2, value: @constant, kind: fixup_16_scale_32
; CHECK:  add   code[@constant+17185], r2, r3          ; encoding: [0x00,0x00,0x43'A',0x21'A',0x03,0x20,0x00,0x41]
; CHECK:  ;   fixup A - offset: 2, value: @constant, kind: fixup_16_scale_32
; CHECK:  add   code[@constant+r1+17185], r2, r3       ; encoding: [0x00,0x00,0x43'A',0x21'A',0x03,0x21,0x00,0x41]
; CHECK:  ;   fixup A - offset: 2, value: @constant, kind: fixup_16_scale_32

; CHECK:  add   stack[@variable + r1], r2, r3         ; encoding: [0x00,0x00,A,A,0x03,0x21,0x00,0x31]
...
; CHECK:  add   r1, r2, stack[@variable + r3]         ; encoding: [A,A,0x00,0x00,0x03,0x21,0x00,0x1f]
