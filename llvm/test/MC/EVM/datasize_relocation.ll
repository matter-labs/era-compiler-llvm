...
; CHECK-NEXT: {{\d*}} R_EVM_DATASIZE_RUNTIME   __evm_datasize_runtime
; CHECK-NEXT: {{\d*}} R_EVM_DATASIZE           __evm_datasize
...
declare i256 @llvm.evm.datasize()
declare i256 @llvm.evm.datasizeruntime()
...
if_join:                                          ; preds = %entry
  %datasize = tail call i256 @llvm.evm.datasize()
  %datasize_rt = tail call i256 @llvm.evm.datasizeruntime()
  %off = sub i256 %datasize, %datasize_rt
  %rt_ptr = inttoptr i256 %off to ptr addrspace(4)
  call void @llvm.memcpy.p1i256.p4i256.i256(ptr addrspace(1) inttoptr (i256 128 to ptr addrspace(1)), ptr addrspace(4) %rt_ptr, i256 %datasize_rt, i1 false)
  tail call void @llvm.evm.return(ptr addrspace(1) noalias nocapture nofree noundef nonnull align 32 inttoptr (i256 128 to ptr addrspace(1)), i256 %datasize_rt)
  unreachable
}
