; RUN: llc -enable-machine-outliner=never < %s | FileCheck %s
...
define i8 addrspace(3)* @spill_ptraddr(i8 addrspace(3)* %a) nounwind {
  ...
  %res = call i8 addrspace(3)* @llvm.syncvm.ptr.add(i8 addrspace(3)* %a, i256 %b)
...
define i8 addrspace(3)* @spill_ptrpackr(i8 addrspace(3)* %a) nounwind {
  ...
  %res = call i8 addrspace(3)* @llvm.syncvm.ptr.pack(i8 addrspace(3)* %a, i256 %b)
  ret i8 addrspace(3)* %res
}
...
define i8 addrspace(3)* @spill_ptrshrinkr(i8 addrspace(3)* %a) nounwind {
  ...
  %res = call i8 addrspace(3)* @llvm.syncvm.ptr.shrink(i8 addrspace(3)* %a, i256 %b)
  ret i8 addrspace(3)* %res
}
...
define i8 addrspace(3)* @spill_ptraddx(i256 %a) nounwind {
  ...
  %res = call i8 addrspace(3)* @llvm.syncvm.ptr.add(i8 addrspace(3)* %b, i256 %a)
  ret i8 addrspace(3)* %res
}
...
define i8 addrspace(3)* @spill_ptrpackx(i256 %a) nounwind {
  ...
  %res = call i8 addrspace(3)* @llvm.syncvm.ptr.pack(i8 addrspace(3)* %b, i256 %a)
  ret i8 addrspace(3)* %res
}
...
define i8 addrspace(3)* @spill_ptrshrinkx(i256 %a) nounwind {
  ...
  %res = call i8 addrspace(3)* @llvm.syncvm.ptr.shrink(i8 addrspace(3)* %b, i256 %a)
  ret i8 addrspace(3)* %res
}
