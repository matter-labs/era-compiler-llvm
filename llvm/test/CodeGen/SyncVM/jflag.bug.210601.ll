...
entry:
  store i256 128, i256* inttoptr (i256 64 to i256*), align 64
...
if.join5:                                         ; preds = %entry
  ...
  %5 = load i256, i256* inttoptr (i256 64 to i256*), align 64
  %6 = add i256 %5, 32
  store i256 %6, i256* inttoptr (i256 64 to i256*), align 64
...
join27:                                           ; preds = %if.join5
  %9 = lshr i256 %5, 5
  %10 = getelementptr i256, i256* null, i256 %9
  store i256 undef, i256* %10, align 32
...
join31:                                           ; preds = %join27
  tail call void @llvm.memcpy.p2i256.p0i256.i256(i256 addrspace(2)* nonnull align 256 dereferenceable(32) inttoptr (i256 256 to i256 addrspace(2)*), i256* nonnull align 32 dereferenceable(32) %10, i256 32, i1 false)
  br label %revert
}
...
declare void @llvm.memcpy.p2i256.p0i256.i256(i256 addrspace(2)* noalias nocapture writeonly, i256* noalias nocapture readonly, i256, i1 immarg) #1
