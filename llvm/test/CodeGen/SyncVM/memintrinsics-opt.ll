...
define fastcc void @huge-copysize0(i256 addrspace(0)* %dest, i256 addrspace(0)* %src) {
  ; CHECK: tail call void @llvm.memcpy.p0i256.p0i256.i256(i256* nocapture writeonly align 1 %dest, i256* nocapture readonly align 1 %src, i256 noundef 81129638414606681695789005144064, i1 noundef false)
...
define fastcc void @huge-copysize1(i256 addrspace(1)* %dest, i256 addrspace(1)* %src) {
  ; CHECK: tail call void @llvm.memcpy.p1i256.p1i256.i256(i256 addrspace(1)* nocapture writeonly align 1 %dest, i256 addrspace(1)* nocapture readonly align 1 %src, i256 noundef 81129638414606681695789005144064, i1 noundef false)
...
define fastcc void @huge-copysize2(i256 addrspace(2)* %dest, i256 addrspace(2)* %src) {
  ; CHECK: tail call void @llvm.memcpy.p2i256.p2i256.i256(i256 addrspace(2)* nocapture writeonly align 1 %dest, i256 addrspace(2)* nocapture readonly align 1 %src, i256 noundef 81129638414606681695789005144064, i1 noundef false)
