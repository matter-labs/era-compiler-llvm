...
; CHECK: %new_exp = mul nuw nsw i256 %a, 3
; CHECK-NEXT: %is_overflow.i = icmp ugt i256 %new_exp, 255
; CHECK-NEXT: %shift_res.i = shl nuw i256 1, %new_exp
; CHECK-NEXT: %res.i = select i1 %is_overflow.i, i256 0, i256 %shift_res.i
...
; CHECK: %is_overflow.i = icmp ugt i256 %a, 255
; CHECK-NEXT: %shift_res.i = shl nuw i256 1, %a
; CHECK-NEXT: %res.i = select i1 %is_overflow.i, i256 0, i256 %shift_res.i
