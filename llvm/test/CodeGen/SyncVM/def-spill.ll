...
define i8 addrspace(3)* @spill_ptraddr(i8 addrspace(3)* %a, i256 %b) nounwind {
  ; CHECK: ptr.add r1, r2, stack-[1]
  %x = call i8 addrspace(3)* @llvm.syncvm.ptr.add(i8 addrspace(3)* %a, i256 %b)
  %c = call i256 @foo()
  %res = call i8 addrspace(3)* @llvm.syncvm.ptr.add(i8 addrspace(3)* %x, i256 %c)
...
define i8 addrspace(3)* @spill_ptraddi(i8 addrspace(3)* %a) nounwind {
  ...
  %x = call i8 addrspace(3)* @llvm.syncvm.ptr.add(i8 addrspace(3)* %a, i256 42)
  %c = call i256 @foo()
  %res = call i8 addrspace(3)* @llvm.syncvm.ptr.add(i8 addrspace(3)* %x, i256 %c)
  ret i8 addrspace(3)* %res
}
...
define i8 addrspace(3)* @spill_ptraddc(i8 addrspace(3)* %a) nounwind {
  ...
  %x = call i8 addrspace(3)* @llvm.syncvm.ptr.add(i8 addrspace(3)* %a, i256 4200000000000000)
  %c = call i256 @foo()
  %res = call i8 addrspace(3)* @llvm.syncvm.ptr.add(i8 addrspace(3)* %x, i256 %c)
  ret i8 addrspace(3)* %res
}
...
define i8 addrspace(3)* @spill_ptradds(i8 addrspace(3)* %a) nounwind {
  %slot = alloca i256
  %b = load i256, i256* %slot
  ; CHECK: ptr.add.s stack-[2], r1, stack-[1]
  %x = call i8 addrspace(3)* @llvm.syncvm.ptr.add(i8 addrspace(3)* %a, i256 %b)
  %c = call i256 @foo()
  %res = call i8 addrspace(3)* @llvm.syncvm.ptr.add(i8 addrspace(3)* %x, i256 %c)
  ret i8 addrspace(3)* %res
...
define i8 addrspace(3)* @spill_ptrpackr(i8 addrspace(3)* %a, i256 %b) nounwind {
  ; CHECK: ptr.pack r1, r2, stack-[1]
  %x = call i8 addrspace(3)* @llvm.syncvm.ptr.pack(i8 addrspace(3)* %a, i256 %b)
  %c = call i256 @foo()
  %res = call i8 addrspace(3)* @llvm.syncvm.ptr.pack(i8 addrspace(3)* %x, i256 %c)
  ret i8 addrspace(3)* %res
}
...
define i8 addrspace(3)* @spill_ptrpacki(i8 addrspace(3)* %a) nounwind {
  ...
  %x = call i8 addrspace(3)* @llvm.syncvm.ptr.pack(i8 addrspace(3)* %a, i256 42)
  %c = call i256 @foo()
  %res = call i8 addrspace(3)* @llvm.syncvm.ptr.pack(i8 addrspace(3)* %x, i256 %c)
  ret i8 addrspace(3)* %res
}
...
define i8 addrspace(3)* @spill_ptrpackc(i8 addrspace(3)* %a) nounwind {
  ...
  %x = call i8 addrspace(3)* @llvm.syncvm.ptr.pack(i8 addrspace(3)* %a, i256 4200000000000000)
  %c = call i256 @foo()
  %res = call i8 addrspace(3)* @llvm.syncvm.ptr.pack(i8 addrspace(3)* %x, i256 %c)
  ret i8 addrspace(3)* %res
}
...
define i8 addrspace(3)* @spill_ptrpacks(i8 addrspace(3)* %a) nounwind {
  %slot = alloca i256
  %b = load i256, i256* %slot
  ; CHECK: ptr.pack.s stack-[2], r1, stack-[1]
  %x = call i8 addrspace(3)* @llvm.syncvm.ptr.pack(i8 addrspace(3)* %a, i256 %b)
  %c = call i256 @foo()
  %res = call i8 addrspace(3)* @llvm.syncvm.ptr.pack(i8 addrspace(3)* %x, i256 %c)
  ret i8 addrspace(3)* %res
...
define i8 addrspace(3)* @spill_ptrshrinkr(i8 addrspace(3)* %a, i256 %b) nounwind {
  ; CHECK: ptr.shrink r1, r2, stack-[1]
  %x = call i8 addrspace(3)* @llvm.syncvm.ptr.shrink(i8 addrspace(3)* %a, i256 %b)
  %c = call i256 @foo()
  %res = call i8 addrspace(3)* @llvm.syncvm.ptr.shrink(i8 addrspace(3)* %x, i256 %c)
  ret i8 addrspace(3)* %res
}
...
define i8 addrspace(3)* @spill_ptrshrinki(i8 addrspace(3)* %a) nounwind {
  ...
  %x = call i8 addrspace(3)* @llvm.syncvm.ptr.shrink(i8 addrspace(3)* %a, i256 42)
  %c = call i256 @foo()
  %res = call i8 addrspace(3)* @llvm.syncvm.ptr.shrink(i8 addrspace(3)* %x, i256 %c)
  ret i8 addrspace(3)* %res
}
...
define i8 addrspace(3)* @spill_ptrshrinkc(i8 addrspace(3)* %a) nounwind {
  ...
  %x = call i8 addrspace(3)* @llvm.syncvm.ptr.shrink(i8 addrspace(3)* %a, i256 4200000000000000)
  %c = call i256 @foo()
  %res = call i8 addrspace(3)* @llvm.syncvm.ptr.shrink(i8 addrspace(3)* %x, i256 %c)
  ret i8 addrspace(3)* %res
}
...
define i8 addrspace(3)* @spill_ptrshrinks(i8 addrspace(3)* %a) nounwind {
  %slot = alloca i256
  %b = load i256, i256* %slot
  ; CHECK: ptr.shrink.s stack-[2], r1, stack-[1]
  %x = call i8 addrspace(3)* @llvm.syncvm.ptr.shrink(i8 addrspace(3)* %a, i256 %b)
  %c = call i256 @foo()
  %res = call i8 addrspace(3)* @llvm.syncvm.ptr.shrink(i8 addrspace(3)* %x, i256 %c)
  ret i8 addrspace(3)* %res
