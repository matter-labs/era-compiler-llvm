...
; RUN: llc -O3 --evm-stack-region-size=32 --evm-stack-region-offset=128 --evm-constant-reload-threshold=2 --enable-constant-spilling-without-unsafe-asm < %s | FileCheck %s
