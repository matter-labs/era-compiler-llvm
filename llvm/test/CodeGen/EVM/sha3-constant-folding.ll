...
; CHECK-SAME: (ptr addrspace(1) captures(none) [[ADDR:%.*]]) local_unnamed_addr #[[ATTR3:[0-9]+]] {
; CHECK-NEXT:  entry:
...
; CHECK-SAME: (ptr addrspace(1) captures(none) [[ADDR:%.*]]) local_unnamed_addr #[[ATTR3]] {
; CHECK-NEXT:  entry:
; CHECK-NEXT:    store i256 0, ptr addrspace(1) [[ADDR]], align 1
; CHECK-NEXT:    [[NEXT_ADDR:%.*]] = getelementptr i8, ptr addrspace(1) [[ADDR]], i256 32
...
; CHECK-SAME: (ptr addrspace(1) captures(none) [[ADDR:%.*]], ptr addrspace(1) writeonly captures(none) [[ADDR2:%.*]]) local_unnamed_addr #[[ATTR3]] {
; CHECK-NEXT:  entry:
; CHECK-NEXT:    store i256 304594385234, ptr addrspace(1) [[ADDR]], align 1
; CHECK-NEXT:    [[NEXT_ADDR:%.*]] = getelementptr i8, ptr addrspace(1) [[ADDR]], i256 32
