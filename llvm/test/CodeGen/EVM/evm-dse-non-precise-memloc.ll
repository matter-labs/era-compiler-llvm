...
; CHECK:       [[IF_MAIN]]:
; CHECK-NEXT:    tail call void @llvm.evm.revert(ptr addrspace(1) noalias nofree noundef nonnull align 32 captures(none) null, i256 32)
...
; CHECK-NEXT:    tail call void @llvm.evm.return(ptr addrspace(1) noalias nofree noundef nonnull align 32 captures(none) inttoptr (i256 128 to ptr addrspace(1)), i256 [[DATASIZE]])
; CHECK-NEXT:    unreachable
;
entry:
  ; To be removed
