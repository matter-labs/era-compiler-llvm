...
; CHECK: Both ModRef:  Ptr: i256* %ptr1	<->  %ret = call i256 @llvm.evm.create.sptr
; CHECK: Both ModRef:  Ptr: i256* %ptr2	<->  %ret = call i256 @llvm.evm.create.sptr
define i256 @test_as6_as5_alias_create(ptr addrspace(5) %ptr1) {
  ...
  %ret = call i256 @llvm.evm.create.sptr(i256 0, ptr addrspace(1) null, i256 1, ptr addrspace(5) null, ptr addrspace(6) null)
  ret i256 %ret
}

; CHECK-LABEL: Function: test_as6_as5_alias_create
; CHECK: Both ModRef:  Ptr: i256* %ptr1	<->  %ret = call i256 @llvm.evm.create2.sptr
; CHECK: Both ModRef:  Ptr: i256* %ptr2	<->  %ret = call i256 @llvm.evm.create2.sptr
define i256 @test_as6_as5_alias_create2(ptr addrspace(5) %ptr1) {
  store i256 1, ptr addrspace(5) %ptr1, align 32
  %ptr2 = inttoptr i256 32 to ptr addrspace(6)
  store i256 2, ptr addrspace(6) %ptr2, align 32
  %ret = call i256 @llvm.evm.create2.sptr(i256 0, ptr addrspace(1) null, i256 1, i256 0, ptr addrspace(5) null, ptr addrspace(6) null)
  ret i256 %ret
}

; CHECK-LABEL: Function: test_as6_as5_alias_call
; CHECK: Both ModRef: Ptr: i256* %ptr1	<->  %ret = call i256 @llvm.evm.call.sptr
; CHECK: Both ModRef: Ptr: i256* %ptr2	<->  %ret = call i256 @llvm.evm.call.sptr
define i256 @test_as6_as5_alias_call(ptr addrspace(5) %ptr1) {
  store i256 1, ptr addrspace(5) %ptr1, align 32
  %ptr2 = inttoptr i256 32 to ptr addrspace(6)
  store i256 2, ptr addrspace(6) %ptr2, align 32
  %ret = call i256 @llvm.evm.call.sptr(i256 1, i256 1, i256 1, ptr addrspace(1) null, i256 1, ptr addrspace(1) null, i256 1, ptr addrspace(5) null, ptr addrspace(6) null)
  ret i256 %ret
}

; CHECK-LABEL: Function: test_as6_as5_alias_staticcall
; CHECK: Both ModRef: Ptr: i256* %ptr1	<->  %ret = call i256 @llvm.evm.staticcall.sptr
; CHECK: Both ModRef: Ptr: i256* %ptr2	<->  %ret = call i256 @llvm.evm.staticcall.sptr
define i256 @test_as6_as5_alias_staticcall(ptr addrspace(5) %ptr1) {
  store i256 1, ptr addrspace(5) %ptr1, align 32
  %ptr2 = inttoptr i256 32 to ptr addrspace(6)
  store i256 2, ptr addrspace(6) %ptr2, align 32
  %ret = call i256 @llvm.evm.staticcall.sptr(i256 1, i256 1, ptr addrspace(1) null, i256 1, ptr addrspace(1) null, i256 1, ptr addrspace(5) null, ptr addrspace(6) null)
  ret i256 %ret
}

; CHECK-LABEL: Function: test_as6_as5_callcode
; CHECK: Both ModRef: Ptr: i256* %ptr1	<->  %ret = call i256 @llvm.evm.callcode.sptr
; CHECK: Both ModRef: Ptr: i256* %ptr2	<->  %ret = call i256 @llvm.evm.callcode.sptr
define i256 @test_as6_as5_callcode(ptr addrspace(5) %ptr1) {
  store i256 1, ptr addrspace(5) %ptr1, align 32
  %ptr2 = inttoptr i256 32 to ptr addrspace(6)
  store i256 2, ptr addrspace(6) %ptr2, align 32
  %ret = call i256 @llvm.evm.callcode.sptr(i256 1, i256 1, i256 1, ptr addrspace(1) null, i256 1, ptr addrspace(1) null, i256 1, ptr addrspace(5) null, ptr addrspace(6) null)
  ret i256 %ret
}

; CHECK-LABEL: Function: test_as6_as5_alias_delegatecall
; CHECK: Both ModRef: Ptr: i256* %ptr1	<->  %ret = call i256 @llvm.evm.delegatecall.sptr
; CHECK: Both ModRef: Ptr: i256* %ptr2	<->  %ret = call i256 @llvm.evm.delegatecall.sptr
define i256 @test_as6_as5_alias_delegatecall(ptr addrspace(5) %ptr1) {
  store i256 1, ptr addrspace(5) %ptr1, align 32
  %ptr2 = inttoptr i256 32 to ptr addrspace(6)
  store i256 2, ptr addrspace(6) %ptr2, align 32
  %ret = call i256 @llvm.evm.delegatecall.sptr(i256 1, i256 1, ptr addrspace(1) null, i256 1, ptr addrspace(1) null, i256 1, ptr addrspace(5) null, ptr addrspace(6) null)
  ret i256 %ret
}

; CHECK-LABEL: Function: test_as6_as5_alias_revert
; CHECK: Just Ref:  Ptr: i256* %ptr1	<->  call void @llvm.evm.revert.sptr
; CHECK: Just Ref:  Ptr: i256* %ptr2	<->  call void @llvm.evm.revert.sptr
define void @test_as6_as5_alias_revert(ptr addrspace(5) %ptr1) noreturn {
  store i256 1, ptr addrspace(5) %ptr1, align 32
  %ptr2 = inttoptr i256 32 to ptr addrspace(6)
  store i256 2, ptr addrspace(6) %ptr2, align 32
  call void @llvm.evm.revert.sptr(ptr addrspace(1) null, i256 0, ptr addrspace(5) null, ptr addrspace(6) null)
  unreachable
}

; CHECK-LABEL: Function: test_as6_as5_alias_return
; CHECK: Just Ref:  Ptr: i256* %ptr1	<->  call void @llvm.evm.return.sptr
; CHECK: Just Ref:  Ptr: i256* %ptr2	<->  call void @llvm.evm.return.sptr
define void @test_as6_as5_alias_return(ptr addrspace(5) %ptr1) noreturn {
  store i256 1, ptr addrspace(5) %ptr1, align 32
  %ptr2 = inttoptr i256 32 to ptr addrspace(6)
  store i256 2, ptr addrspace(6) %ptr2, align 32
  call void @llvm.evm.return.sptr(ptr addrspace(1) null, i256 0, ptr addrspace(5) null, ptr addrspace(6) null)
  unreachable
}
