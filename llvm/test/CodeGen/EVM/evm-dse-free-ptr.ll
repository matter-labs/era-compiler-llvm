...
; CHECK-NEXT:    tail call void @llvm.evm.return.sptr(ptr addrspace(1) noalias nocapture nofree noundef nonnull align 32 inttoptr (i256 128 to ptr addrspace(1)), i256 32, ptr addrspace(5) null, ptr addrspace(6) null)
; CHECK-NEXT:    unreachable
...
"block_rt_3/0.i":
  ...
  tail call void @llvm.evm.return.sptr(ptr addrspace(1) noalias nocapture nofree noundef nonnull align 32 inttoptr (i256 128 to ptr addrspace(1)), i256 32, ptr addrspace(5) null, ptr addrspace(6) null)
  unreachable
