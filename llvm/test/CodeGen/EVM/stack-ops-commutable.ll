...
declare void @llvm.evm.return.sptr.sptr(ptr addrspace(1), i256, ptr addrspace(5), ptr addrspace(6))
declare void @llvm.evm.revert.sptr.sptr(ptr addrspace(1), i256, ptr addrspace(5), ptr addrspace(6))
