...
; CHECK-NEXT:    PUSH0
; CHECK-NEXT:    SWAP1
; CHECK-NEXT:    PUSH2 2048
; CHECK-NEXT:    AND
; CHECK-NEXT:    ISZERO
; CHECK-NEXT:    PUSH4 @.BB2_3
; CHECK-NEXT:    JUMPI
; CHECK-NEXT:    PUSH4 @.BB2_1
; CHECK-NEXT:    JUMP
; CHECK-NEXT:  .BB2_3:
; CHECK-NEXT:    JUMPDEST
; CHECK-NEXT:    SWAP2
...
; CHECK-NEXT:    JUMP
; CHECK-NEXT:  .BB2_1: ; %entry
; CHECK-NEXT:    JUMPDEST
; CHECK-NEXT:    POP
; CHECK-NEXT:    SWAP1
; CHECK-NEXT:  .BB2_2: ; %entry
; CHECK-NEXT:    JUMPDEST
; CHECK-NEXT:    JUMP
entry:
  %and = and i256 %x, 2048
...
; CHECK-NEXT:    JUMP
; CHECK-NEXT:  .BB3_1: ; %entry
; CHECK-NEXT:    JUMPDEST
; CHECK-NEXT:    POP
; CHECK-NEXT:    PUSH0
; CHECK-NEXT:    SWAP1
; CHECK-NEXT:  .BB3_2: ; %entry
; CHECK-NEXT:    JUMPDEST
; CHECK-NEXT:    JUMP
entry:
...
; CHECK-NEXT:    JUMP
; CHECK-NEXT:  .BB5_1: ; %entry
; CHECK-NEXT:    JUMPDEST
; CHECK-NEXT:    POP
; CHECK-NEXT:    PUSH0
; CHECK-NEXT:    SWAP1
; CHECK-NEXT:  .BB5_2: ; %entry
; CHECK-NEXT:    JUMPDEST
; CHECK-NEXT:    JUMP
entry:
...
; CHECK-NEXT:    JUMP
; CHECK-NEXT:  .BB6_1: ; %entry
; CHECK-NEXT:    JUMPDEST
; CHECK-NEXT:    POP
; CHECK-NEXT:    PUSH0
; CHECK-NEXT:    SWAP1
; CHECK-NEXT:  .BB6_2: ; %entry
; CHECK-NEXT:    JUMPDEST
; CHECK-NEXT:    JUMP
entry:
  %cmp = icmp slt i256 %x, 0
