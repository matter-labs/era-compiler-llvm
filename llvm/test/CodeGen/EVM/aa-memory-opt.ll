...
; CHECK-SAME: (ptr addrspace(5) writeonly captures(none) [[PTR1:%.*]], ptr addrspace(6) writeonly captures(none) [[PTR2:%.*]]) local_unnamed_addr #[[ATTR3]] {
...
; CHECK-SAME: (ptr addrspace(5) captures(none) [[PTR1:%.*]], ptr addrspace(6) captures(none) [[PTR2:%.*]]) local_unnamed_addr #[[ATTR3]] {
; CHECK-NEXT:    store i256 1, ptr addrspace(5) [[PTR1]], align 32
; CHECK-NEXT:    store i256 2, ptr addrspace(6) [[PTR2]], align 32
