; RUN: opt -S -mtriple=evm -passes="mergebb,simplifycfg<switch-range-to-icmp>" < %s | FileCheck %s
...
; CHECK-NEXT:    br i1 [[SWITCH]], label [[BB1:%.*]], label [[BB3:%.*]]
; CHECK:       bb1:
; CHECK-NEXT:    [[V1:%.*]] = load ptr, ptr [[P1:%.*]], align 4, !nonnull !0
; CHECK-NEXT:    store ptr [[V1]], ptr [[P2:%.*]], align 32
; CHECK-NEXT:    br label [[EXIT:%.*]]
; CHECK:       bb3:
; CHECK-NEXT:    call void @dummy()
; CHECK-NEXT:    br label [[EXIT]]
...
; CHECK-NEXT:    br i1 [[SWITCH]], label [[BB1:%.*]], label [[BB3:%.*]]
; CHECK:       bb1:
; CHECK-NEXT:    [[V1:%.*]] = load ptr, ptr [[P1:%.*]], align 4
; CHECK-NEXT:    store ptr [[V1]], ptr [[P2:%.*]], align 32
; CHECK-NEXT:    br label [[EXIT:%.*]]
; CHECK:       bb3:
; CHECK-NEXT:    call void @dummy()
...
; CHECK-NEXT:    br i1 [[SWITCH]], label [[BB1:%.*]], label [[BB3:%.*]]
; CHECK:       bb1:
; CHECK-NEXT:    [[V1:%.*]] = load i32, ptr [[P1:%.*]], align 4, !range !1
; CHECK-NEXT:    store i32 [[V1]], ptr [[P2:%.*]], align 4
; CHECK-NEXT:    br label [[EXIT:%.*]]
; CHECK:       bb3:
; CHECK-NEXT:    call void @dummy()
; CHECK-NEXT:    br label [[EXIT]]
