...
; CHECK-NEXT:  ; %bb.2: ; %memmove-residual
...
; CHECK:       ; %bb.0: ; %entry
; CHECK-NEXT:    sub! r2, r1, r0
; CHECK-NEXT:    jump.ge @.BB2_4
; CHECK-NEXT:  ; %bb.1: ; %copy-backwards
; CHECK-NEXT:    add 32, r0, r3
; CHECK-NEXT:    sub.s 22, r1, r4
; CHECK-NEXT:    sub.s 22, r2, r5
; CHECK-NEXT:  .BB2_2: ; %copy-backwards-loop
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
