...
; CHECK-NEXT:  add     r2, r0, [[LDBASE:r[0-9]+]]
; CHECK-NEXT:  add     r1, r0, [[STBASE:r[0-9]+]]
; CHECK-NEXT:.BB1_1:
; CHECK:       ld.1.inc   [[LDBASE]], [[LDVAL:r[0-9]+]], [[LDBASE]]
; CHECK-NEXT:  st.1.inc   [[STBASE]], [[LDVAL]], [[STBASE]]
; CHECK-NEXT:  sub!       [[STBASE]], r3, r{{[0-9]+}}
...
; CHECK:   add     32, [[LOAD_SHIFT_AMMOUNT:r[0-9]+]], [[LOAD_SHIFT_AMMOUNT:r[0-9]+]]
; CHECK:   add     32, [[STORE_SHIFT_AMMOUNT:r[0-9]+]], [[STORE_SHIFT_AMMOUNT:r[0-9]+]]
; CHECK:   sub!    [[STORE_SHIFT_AMMOUNT:r[0-9]+]], r3, r{{[0-9]+}}
; CHECK:   jump.ne @.BB3_1
; CHECK:   ret
...
; CHECK:   sub!    [[SHIFT_COUNT_DST]], r3, r{{[0-9]+}}
; CHECK:   jump.ne @.BB4_1
...
; CHECK: CPI1_0:
; CHECK: CPI2_0:
; CHECK:        .cell 81129638414606681695789005144064
