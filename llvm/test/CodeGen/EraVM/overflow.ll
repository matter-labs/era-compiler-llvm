...
; CHECK-NEXT:    sub! r1, r2, r6
; CHECK-NEXT:    add.ge r5, r0, r3
; CHECK-NEXT:    sub! r5, r4, r4
; CHECK-NEXT:    add 0, r0, r4
; CHECK-NEXT:    add.lt 1, r0, r4
; CHECK-NEXT:    sub! r4, r0, r4
; CHECK-NEXT:    add.eq r2, r0, r1
...
define i256 @add_test_large_immx(i256 %a, i256 %b, i256 %x, i256 %y) {
; CHECK-LABEL: add_test_large_immx:
; CHECK:       ; %bb.0: ; %entry
; CHECK-NEXT:    add @CPI4_0[0], r3, r4
; CHECK-NEXT:    sub! r4, r3, r3
; CHECK-NEXT:    add 0, r0, r3
; CHECK-NEXT:    add.lt 1, r0, r3
; CHECK-NEXT:    sub! r3, r0, r3
...
; CHECK-NEXT:    ret
entry:
  %res1 = call {i256, i1} @llvm.uadd.with.overflow.i256(i256 26959946660873538059280334323183841250350249843923952699046031785980, i256 %x)
  %overflow = extractvalue {i256, i1} %res1, 1
  %selected = select i1 %overflow, i256 %a, i256 %b
  ret i256 %selected
}
...
; CHECK-NEXT:    add.ne @CPI6_0[0], r0, r1
; CHECK-NEXT:    ret
entry:
  %res1 = call {i256, i1} @llvm.uadd.with.overflow.i256(i256 %x, i256 %y)
  %overflow = extractvalue {i256, i1} %res1, 1
...
; CHECK-NEXT:    sub! r1, r0, r1
; CHECK-NEXT:    add r0, r0, r1
; CHECK-NEXT:    add.ne @CPI7_0[0], r0, r1
; CHECK-NEXT:    ret
entry:
  %res1 = call {i256, i1} @llvm.uadd.with.overflow.i256(i256 %x, i256 %y)
  %overflow = extractvalue {i256, i1} %res1, 1
...
; CHECK-NEXT:    sub! r1, r0, r1
; CHECK-NEXT:    add 42, r0, r1
; CHECK-NEXT:    add.ne @CPI12_0[0], r0, r1
; CHECK-NEXT:    ret
entry:
  %res1 = call {i256, i1} @llvm.uadd.with.overflow.i256(i256 %x, i256 %y)
  %overflow = extractvalue {i256, i1} %res1, 1
...
; CHECK-NEXT:    add.lt 1, r0, r1
; CHECK-NEXT:    sub! r1, r0, r1
; CHECK-NEXT:    add @CPI15_0[0], r0, r1
...
; CHECK-NEXT:    add.lt 1, r0, r2
; CHECK-NEXT:    sub! r2, r0, r2
; CHECK-NEXT:    add.eq @CPI16_0[0], r0, r1
; CHECK-NEXT:    ret
entry:
  %res1 = call {i256, i1} @llvm.uadd.with.overflow.i256(i256 %x, i256 %y)
  %overflow = extractvalue {i256, i1} %res1, 1
...
; CHECK-NEXT:    sub! r1, r0, r1
; CHECK-NEXT:    add @val[0], r0, r1
; CHECK-NEXT:    add.ne @val2[0], r0, r1
; CHECK-NEXT:    ret
entry:
  %res1 = call {i256, i1} @llvm.uadd.with.overflow.i256(i256 %x, i256 %y)
  %overflow = extractvalue {i256, i1} %res1, 1
...
; CHECK-NEXT:    add.lt 1, r0, r1
; CHECK-NEXT:    sub! r1, r0, r1
; CHECK-NEXT:    add @CPI20_0[0], r0, r1
; CHECK-NEXT:    add.ne @val[0], r0, r1
; CHECK-NEXT:    ret
entry:
  %res1 = call {i256, i1} @llvm.uadd.with.overflow.i256(i256 %x, i256 %y)
...
; CHECK-NEXT:    sub! r1, r0, r1
; CHECK-NEXT:    add @val[0], r0, r1
; CHECK-NEXT:    add.ne @CPI21_0[0], r0, r1
; CHECK-NEXT:    ret
entry:
  %res1 = call {i256, i1} @llvm.uadd.with.overflow.i256(i256 %x, i256 %y)
  %overflow = extractvalue {i256, i1} %res1, 1
...
; CHECK-NEXT:    add.lt 1, r0, r1
; CHECK-NEXT:    sub! r1, r0, r1
; CHECK-NEXT:    add @CPI22_1[0], r0, r1
; CHECK-NEXT:    add.ne @CPI22_0[0], r0, r1
; CHECK-NEXT:    ret
entry:
  %res1 = call {i256, i1} @llvm.uadd.with.overflow.i256(i256 %x, i256 %y)
  %overflow = extractvalue {i256, i1} %res1, 1
...
; CHECK-NEXT:    add.lt 1, r0, r1
; CHECK-NEXT:    sub! r1, r0, r1
; CHECK-NEXT:    add @CPI24_0[0], r0, r1
; CHECK-NEXT:    add.ne stack-[1], r0, r1
; CHECK-NEXT:    ret
entry:
  %ptr = alloca i256
...
; CHECK-NEXT:    sub! r1, r0, r1
; CHECK-NEXT:    add stack-[1], r0, r1
; CHECK-NEXT:    add.ne @CPI28_0[0], r0, r1
; CHECK-NEXT:    ret
entry:
  %data = alloca i256
  %res1 = call {i256, i1} @llvm.uadd.with.overflow.i256(i256 %x, i256 %y)
...
; CHECK:       ; %bb.0: ; %entry
; CHECK-NEXT:    sub r3, r4, r4
; CHECK-NEXT:    sub! r4, r3, r3
; CHECK-NEXT:    add 0, r0, r3
; CHECK-NEXT:    add.gt 1, r0, r3
; CHECK-NEXT:    sub! r3, r0, r3
; CHECK-NEXT:    add.eq r2, r0, r1
; CHECK-NEXT:    ret
entry:
...
; CHECK:       ; %bb.0: ; %entry
; CHECK-NEXT:    add @CPI47_0[0], r3, r4
; CHECK-NEXT:    sub! r4, r3, r3
; CHECK-NEXT:    add 0, r0, r3
; CHECK-NEXT:    add.gt 1, r0, r3
; CHECK-NEXT:    sub! r3, r0, r3
...
; CHECK:       ; %bb.0: ; %entry
; CHECK-NEXT:    sub @CPI48_0[0], r1, r3
; CHECK-NEXT:    sub.s! @CPI48_0[0], r3, r3
; CHECK-NEXT:    add 0, r0, r3
; CHECK-NEXT:    add.gt 1, r0, r3
; CHECK-NEXT:    sub! r3, r0, r3
; CHECK-NEXT:    add.eq r2, r0, r1
...
; CHECK:       ; %bb.0: ; %entry
; CHECK-NEXT:    mul @CPI50_0[0], r3, r3, r4
; CHECK-NEXT:    sub! r4, r0, r3
; CHECK-NEXT:    add 0, r0, r3
; CHECK-NEXT:    add.ne 1, r0, r3
; CHECK-NEXT:    sub! r3, r0, r3
