...
; CHECK-NEXT:    or.lt code[@CPI0_0], r1, r1
; CHECK-NEXT:    ret
  %or = or i256 26959946660873538059280334323183841250350249843923952699046031785980, %a
...
; CHECK-NEXT:    or.ge code[@CPI1_0], r1, r1
; CHECK-NEXT:    ret
  %or = or i256 26959946660873538059280334323183841250350249843923952699046031785980, %a
  %cmp = icmp ult i256 %a, -26959946660873538059280334323183841250350249843923952699046031785985
