...
; CHECK-LABEL: srem:
; CHECK:       ; %bb.0:
; CHECK-NEXT:    div.s! code[@CPI0_0], r2, r0, r2
; CHECK-NEXT:    sub.ne code[@CPI0_0], r2, r2
; CHECK-NEXT:    div.s! code[@CPI0_0], r1, r0, r3
; CHECK-NEXT:    sub.ne code[@CPI0_0], r3, r3
; CHECK-NEXT:    div r3, r2, r0, r2
; CHECK-NEXT:    and! code[@CPI0_0], r1, r0
