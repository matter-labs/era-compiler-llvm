...
; CHECK-NEXT:   sub     @CPI0_0[0], [[REG3:r[0-9]+]], [[REG2]]
; CHECK-NEXT:   add.eq  [[REG3]], r0, [[REG2]]
; CHECK-NEXT:   div.s!  @CPI0_0[0], [[REG1:r[0-9]+]], [[REG3]], [[REG4:r[0-9]+]]
; CHECK-NEXT:   sub     @CPI0_0[0], [[REG4]], [[REG3]]
; CHECK-NEXT:   add.eq  [[REG4]], r0, [[REG3]]
; CHECK-NEXT:   div     [[REG3]], [[REG2]], [[REG3]], [[REG2]]
...
; CHECK-NEXT:        sub     @CPI{{[0-9]+}}_0[0], [[REGsdiv3]], [[REGsdiv4:r[0-9]+]]
; CHECK-NEXT:        add.eq  [[REGsdiv3]], r0, [[REGsdiv4]]
...
; CHECK-NEXT:        div     [[REGsdiv1]], [[REGsdiv4]], [[REGsdiv1]], [[REGsdiv3]]
...
; CHECK-NEXT:  sub     @CPI{{[0-9]+}}_0[0], [[REGsdivrem3]], [[REGsdivrem4:r[0-9]+]]
; CHECK-NEXT:  add.eq  [[REGsdivrem3]], r0, [[REGsdivrem4]]
; CHECK-NEXT:  div.s!  @CPI{{[0-9]+}}_0[0], [[REGsdivrem1:r[0-9]+]], [[REGsdivrem3]], [[REGsdivrem5:r[0-9]+]]
; CHECK-NEXT:  xor     [[REGsdivrem3]], [[REGsdivrem2]], [[REGsdivrem2]]
; CHECK-NEXT:  sub     @CPI{{[0-9]+}}_0[0], [[REGsdivrem5]], [[REGsdivrem3]]
; CHECK-NEXT:  add.eq  [[REGsdivrem5]], r0, [[REGsdivrem3]]
; CHECK-NEXT:  div     [[REGsdivrem3]], [[REGsdivrem4]], [[REGsdivrem4]], [[REGsdivrem3]]
