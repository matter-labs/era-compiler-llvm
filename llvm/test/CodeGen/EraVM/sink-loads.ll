...
; RUN: opt -passes=eravm-post-codegen-prepare -eravm-enable-load-sinking -S < %s | FileCheck %s
...
; CHECK-NEXT:    [[TMP0:%.*]] = load ptr addrspace(3), ptr @glob, align 32
; CHECK-NEXT:    [[ADDP1:%.*]] = call ptr addrspace(3) @llvm.eravm.ptr.add(ptr addrspace(3) [[TMP0]], i256 [[I]])
...
; CHECK:       loop_body:
; CHECK-NEXT:    [[TMP1:%.*]] = load ptr addrspace(3), ptr @glob, align 32
; CHECK-NEXT:    [[ADDP2:%.*]] = call ptr addrspace(3) @llvm.eravm.ptr.add(ptr addrspace(3) [[TMP1]], i256 1)
