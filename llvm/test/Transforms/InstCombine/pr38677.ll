...
; CHECK:       final:
; CHECK-NEXT:    [[C3:%.*]] = phi i1 [ icmp eq (i32 select (i1 icmp eq (ptr @A, ptr @B), i32 2, i32 1), i32 0), [[DELAY]] ], [ false, [[ENTRY:%.*]] ]
; CHECK-NEXT:    [[USE2:%.*]] = phi i32 [ select (i1 icmp eq (ptr @A, ptr @B), i32 2, i32 1), [[DELAY]] ], [ 1, [[ENTRY]] ]
