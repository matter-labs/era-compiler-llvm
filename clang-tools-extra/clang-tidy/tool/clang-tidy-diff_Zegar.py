...
#  This is a revision of clang-tidy-diff.py by Piotr Zegar: https://reviews.llvm.org/D158929
# for https://github.com/llvm/llvm-project/issues/65000, committed upstream,
# updated to c019ed9. 
